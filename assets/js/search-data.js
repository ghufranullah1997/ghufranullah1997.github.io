    ...
    handler: () => {
      window.location.href = "/al-folio/";
        ...
        handler: () => {
            ...
            window.location.href = "/al-folio/blog/2024/photo-gallery-copy/";
        ...
        handler: () => {
          ...
          description: "",
          section: "News",},{id: "news-started-masters-in-data-analytics-from-university-of-turku",
          title: 'Started Masters in Data Analytics from University of Turku.',
          description: "",
        ...
        section: 'Socials',
        handler: () => {
          window.open("mailto:%67%68%75%66%72%61%6E%75%6C%6C%61%68.%61%6D%75@%67%6D%61%69%6C.%63%6F%6D", "_blank");
        },
      },{
        id: 'social-github',
        title: 'GitHub',
        section: 'Socials',
        handler: () => {
          window.open("https://github.com/https://github.com/ghufranullah1997/", "_blank");
        },
      },{
        id: 'social-linkedin',
        title: 'LinkedIn',
        section: 'Socials',
        handler: () => {
          window.open("https://www.linkedin.com/in/ghufranullah1997", "_blank");
        },
      },{
        id: 'social-orcid',
        title: 'ORCID',
        section: 'Socials',
        handler: () => {
          window.open("https://orcid.org/0000-0003-3910-802X", "_blank");
        },
      },{
        id: 'social-scholar',
        ...
        section: 'Socials',
        handler: () => {
          window.open("https://scholar.google.com/citations?user=https://scholar.google.com/citations?hl=en&user=3mNUss4AAAAJ&inst=1090839925178179799", "_blank");
        },
      },{
        id: 'social-whatsapp',
        title: 'whatsapp',
        section: 'Socials',
        handler: () => {
          window.open("https://wa.me/919808688692", "_blank");
        },
      },{
      id: 'light-theme',
